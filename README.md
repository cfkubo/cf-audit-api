<p align="center">
<img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Ftanzu.vmware.com%2Fapplication-service&psig=AOvVaw0UcK2UNIcqS4f2oGbZsTB_&ust=1706142536741000&source=images&cd=vfe&opi=89978449&ved=0CBMQjRxqFwoTCODxkrTi9IMDFQAAAAAdAAAAABAD" width="300" alt="Online Boutique" />
</p>
...
```
### Fetch the token via curl

```
avannala@avannalaCX6H4 tas % curl -k https://uaa.sys.h2o-4-15402.h2o.vmware.com/oauth/token -u "arul5:arul5" -d grant_type=client_credentials
...
```
curl -k 'https://uaa.sys.h2o-4-15402.h2o.vmware.com/Users' -i -X GET \
