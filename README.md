...
# TAS UAA Target
```
avannala@avannalaCX6H4 tas % uaac target uaa.sys.XXXXXXXXX.h2o.vmware.com  --skip-ssl-validation
...
```
avannala@avannalaCX6H4 tas % curl -k https://uaa.sys.XXXXXXXXX.h2o.vmware.com/oauth/token -u "arul5:arul5" -d grant_type=client_credentials
